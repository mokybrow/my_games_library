...
export const ArticleCard: FC<ArticleCardProps> = ({ src, title, username, comment, img, grade, slug, columnSpan, created_at }) => {
        ...
        <>
            <div className="medium-card-container" style={{ gridColumnEnd: `span ${columnSpan}` }}>
                <div className="img-container">
                    <img src={`data:image/jpeg;base64,${src}`} alt='' width="150" height="150" />
                </div>
                <div className="text-container">
                    <div className="text-container-header" >
                        ...
                        <div className="user-grade-container">
                            {grade !== null ? <span className='grade-number-container'>
                                <FormattedNumber
                                value={grade}/></span> : <span className='grade-number-container'>
