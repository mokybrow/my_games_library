...
import { CheckGameInDefaultListsResponseModel, CheckGameInUserListsResponseModel, ListsGameResponse, checkAddedListsGameResponse } from "../models/listModels";
import { UserListsResponse } from "../models/userModels";

export default class ListService {

    static async createList(title: string, description: string | null, is_private: boolean, img: any): Promise<AxiosResponse> {
