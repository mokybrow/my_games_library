...
from games_library_api.integrations.game_operations import  get_all_games,  get_count_games, get_game, get_game_avg_rate, get_game_review, get_game_review_for_all, get_new_games
...
async def get_all_games_router(page: int, sort: Optional[str]=None, decade: Optional[str]=None, genre: Optional[str]=None, db: AsyncSession = Depends(get_async_session)):
...
async def get_all_games_router( sort: Optional[str]=None, decade: Optional[str]=None, genre: Optional[str]=None, db: AsyncSession = Depends(get_async_session)):
