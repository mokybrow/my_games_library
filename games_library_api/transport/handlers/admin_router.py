...
@router.post("/admin/get_all_users/", response_model=list[users_model.UserResponseModel])
async def add_new_game(db: AsyncSession = Depends(get_async_session),
    user: User = Depends(current_superuser)) ->List[users_model.UserResponseModel]:
