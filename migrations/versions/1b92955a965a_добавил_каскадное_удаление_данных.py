...
down_revision: Union[str, None] = "91d5fc1be3db"
...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        None, "follower", "user", ["user_id"], ["id"], ondelete="CASCADE"
    )
    op.create_foreign_key(
        None, "follower", "user", ["follower_id"], ["id"], ondelete="CASCADE"
    )
    ...
    op.create_foreign_key(
        None, "like_game", "game", ["game_id"], ["id"], ondelete="CASCADE"
    )
    op.create_foreign_key(
        None, "like_game", "like", ["list_id"], ["id"], ondelete="CASCADE"
    )
    op.drop_constraint("list_owner_id_fkey", "list", type_="foreignkey")
    op.create_foreign_key(
        None, "list", "user", ["owner_id"], ["id"], ondelete="CASCADE"
    )
    ...
    op.create_foreign_key(
        None, "list_game", "list", ["list_id"], ["id"], ondelete="CASCADE"
    )
    op.create_foreign_key(
        None, "list_game", "game", ["game_id"], ["id"], ondelete="CASCADE"
    )
    ...
    op.create_foreign_key(
        None, "list_user", "list", ["list_id"], ["id"], ondelete="CASCADE"
    )
    op.create_foreign_key(
        None, "list_user", "user", ["user_id"], ["id"], ondelete="CASCADE"
    )
    op.drop_constraint("passed_user_id_fkey", "passed", type_="foreignkey")
    op.create_foreign_key(
        None, "passed", "user", ["user_id"], ["id"], ondelete="CASCADE"
    )
    ...
    op.create_foreign_key(
        None, "passed_game", "game", ["game_id"], ["id"], ondelete="CASCADE"
    )
    op.create_foreign_key(
        None, "passed_game", "passed", ["list_id"], ["id"], ondelete="CASCADE"
    )
    ...
    op.create_foreign_key(
        None, "review", "user", ["user_id"], ["id"], ondelete="CASCADE"
    )
    op.create_foreign_key(
        None, "review", "game", ["game_id"], ["id"], ondelete="CASCADE"
    )
    op.drop_constraint("wantplay_user_id_fkey", "wantplay", type_="foreignkey")
    op.create_foreign_key(
        None, "wantplay", "user", ["user_id"], ["id"], ondelete="CASCADE"
    )
    op.drop_constraint(
        "wantplay_game_list_id_fkey", "wantplay_game", type_="foreignkey"
    )
    op.drop_constraint(
        "wantplay_game_game_id_fkey", "wantplay_game", type_="foreignkey"
    )
    op.create_foreign_key(
        None, "wantplay_game", "game", ["game_id"], ["id"], ondelete="CASCADE"
    )
    op.create_foreign_key(
        None, "wantplay_game", "wantplay", ["list_id"], ["id"], ondelete="CASCADE"
    )
...
def downgrade() -> None:
    ...
    op.drop_constraint(None, "wantplay_game", type_="foreignkey")
    op.create_foreign_key(
        "wantplay_game_game_id_fkey", "wantplay_game", "game", ["game_id"], ["id"]
    )
    op.create_foreign_key(
        "wantplay_game_list_id_fkey", "wantplay_game", "wantplay", ["list_id"], ["id"]
    )
    op.drop_constraint(None, "wantplay", type_="foreignkey")
    op.create_foreign_key(
        "wantplay_user_id_fkey", "wantplay", "user", ["user_id"], ["id"]
    )
    ...
    op.drop_constraint(None, "passed_game", type_="foreignkey")
    op.create_foreign_key(
        "passed_game_list_id_fkey", "passed_game", "passed", ["list_id"], ["id"]
    )
    op.create_foreign_key(
        "passed_game_game_id_fkey", "passed_game", "game", ["game_id"], ["id"]
    )
    ...
    op.drop_constraint(None, "list_user", type_="foreignkey")
    op.create_foreign_key(
        "list_user_user_id_fkey", "list_user", "user", ["user_id"], ["id"]
    )
    op.create_foreign_key(
        "list_user_list_id_fkey", "list_user", "list", ["list_id"], ["id"]
    )
    op.drop_constraint(None, "list_game", type_="foreignkey")
    op.drop_constraint(None, "list_game", type_="foreignkey")
    op.create_foreign_key(
        "list_game_game_id_fkey", "list_game", "game", ["game_id"], ["id"]
    )
    op.create_foreign_key(
        "list_game_list_id_fkey", "list_game", "list", ["list_id"], ["id"]
    )
    ...
    op.drop_constraint(None, "like_game", type_="foreignkey")
    op.create_foreign_key(
        "like_game_list_id_fkey", "like_game", "like", ["list_id"], ["id"]
    )
    op.create_foreign_key(
        "like_game_game_id_fkey", "like_game", "game", ["game_id"], ["id"]
    )
    ...
    op.drop_constraint(None, "follower", type_="foreignkey")
    op.create_foreign_key(
        "follower_user_id_fkey", "follower", "user", ["user_id"], ["id"]
    )
    op.create_foreign_key(
        "follower_follower_id_fkey", "follower", "user", ["follower_id"], ["id"]
    )
    # ### end Alembic commands ###
